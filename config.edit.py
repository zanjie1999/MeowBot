...
chat_rule = (
    ...
    (['早上好', '早安', '早呀', '早啊'], ['早', '早呀', '早上好', '(我通宵了)'], (5, 14), ['[cq:face,id=178][cq:face,id=146]', '你在想🍑', '现在不早了', '现在已经很晚了', '好晚...']),
    (['晚安', ['睡觉', '了']], ['安', '晚安', '睡什么睡（'], (20, 6), ['[cq:face,id=178][cq:face,id=146]', '你在想🍑', '现在是早上诶', '别睡了块来玩啊']),
    ([['我', '渴望']], ['你渴望', '嗯?']),
